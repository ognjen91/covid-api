<template>
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <router-link to="/" class="text-white px-3 py-2 rounded-md text-sm font-medium">{{$t('header.home')}}</router-link>

                <router-link to="/countries" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$t('header.countries')}}</router-link>

                <router-link to="/my-feed" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$t('header.feed')}}</router-link>

                <router-link to="/about" class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$t('header.about')}}</router-link>
  ...
  <!-- <header class='flex justify-center border'>
    <div id='nav' class='w-full flex justify-center py-5'>
      <router-link to='/' tag='li' class='mx-2'>Home</router-link>
      <router-link to='/countries' class='mx-2'>Countries</router-link>
    </div>
  </header> -->
